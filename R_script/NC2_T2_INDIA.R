NC_T2_INDIA <- function(out.dir,ncfile, DAYY,TIME,NDAYS,nv_time,stat,end){
...
pdf(paste("NC2PDF/T2_INDIA_",format(as.Date(DAYY), "%Y_%b_%d "),TIME,".pdf",sep = ""), width = 10 , height =7.5 ,onefile=T,bg="white")
